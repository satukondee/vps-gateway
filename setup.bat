...
if %errorlevel% neq 0 (
    ...
    echo [1/5] Python is already installed.
)

echo [2/5] Installing MetaTrader5, FastAPI, and Uvicorn...
python -m pip install --upgrade pip
python -m pip install MetaTrader5 fastapi uvicorn pydantic
...
echo start "AIVANA Python Gateway" python gateway.py
...
echo ===================================================
echo.
start "AIVANA Python Gateway" python gateway.py
